...
## `data/companies.csv` (788 rows, 25 variables)

The register includes 718 operating organisations and 70 that no longer operate.
...
## `data/coverage_spatial.csv` (788 rows, 14 variables)
...
## `data/coverage_country.csv` (32,679 rows, 9 variables)
