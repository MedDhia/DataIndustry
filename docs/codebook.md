...
## `data/companies.csv` (857 rows, 25 variables)

The register includes 786 operating organisations and 71 that no longer operate.
...
## `data/coverage_spatial.csv` (857 rows, 14 variables)
...
## `data/coverage_country.csv` (33,065 rows, 9 variables)
