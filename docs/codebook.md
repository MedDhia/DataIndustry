...
## `data/companies.csv` (826 rows, 25 variables)

The register includes 756 operating organisations and 70 that no longer operate.
...
## `data/coverage_spatial.csv` (826 rows, 14 variables)
...
## `data/coverage_country.csv` (32,944 rows, 9 variables)
