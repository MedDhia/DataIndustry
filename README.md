...
A register of 788 organisations that collect data as their business, 718 of them
...
|---|---|---|
| `data/companies.csv` | 788 | The register. One row per organisation, 25 variables. 718 operating, 70 exited. |
...
uses the 718 operating firms only**; `scripts/05_history.R` analyses the rest.
